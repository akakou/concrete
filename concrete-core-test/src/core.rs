...
test! {
    ...
    (GlweCiphertextViewCreationFixture, (GlweCiphertextView)),
    (GlweCiphertextMutViewCreationFixture, (GlweCiphertextMutView)),
    (GlweCiphertextViewRetrievalFixture, (GlweCiphertextView)),
    (GlweCiphertextMutViewRetrievalFixture, (GlweCiphertextMutView)),
    ...
    (LweCiphertextViewCreationFixture, (LweCiphertextView)),
    (LweCiphertextMutViewCreationFixture, (LweCiphertextMutView)),
    (LweCiphertextViewRetrievalFixture, (LweCiphertextView)),
    (LweCiphertextMutViewRetrievalFixture, (LweCiphertextMutView)),
