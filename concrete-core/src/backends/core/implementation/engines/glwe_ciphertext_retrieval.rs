...
use crate::specification::engines::{GlweCiphertextRetrievalEngine, GlweCiphertextRetrievalError};
...
impl<'data> GlweCiphertextRetrievalEngine<GlweCiphertextView32<'data>, &'data [u32]>
    for CoreEngine
{
    /// # Example:
    /// ```
    ...
    /// let retrieved_slice = engine.retrieve_glwe_ciphertext(ciphertext_view)?;
    ...
    ) -> Result<&'data [u32], GlweCiphertextRetrievalError<Self::EngineError>> {
        Ok(unsafe { self.retrieve_glwe_ciphertext_unchecked(ciphertext) })
    }

    unsafe fn retrieve_glwe_ciphertext_unchecked(
        &mut self,
        ciphertext: GlweCiphertextView32<'data>,
    ) -> &'data [u32] {
...
impl<'data> GlweCiphertextRetrievalEngine<GlweCiphertextMutView32<'data>, &'data mut [u32]>
    for CoreEngine
{
    /// # Example:
    /// ```
    ...
    ) -> Result<&'data mut [u32], GlweCiphertextRetrievalError<Self::EngineError>> {
        Ok(unsafe { self.retrieve_glwe_ciphertext_unchecked(ciphertext) })
    }
...
impl<'data> GlweCiphertextRetrievalEngine<GlweCiphertextView64<'data>, &'data [u64]>
    for CoreEngine
{
    /// # Example:
    /// ```
    ...
    ) -> Result<&'data [u64], GlweCiphertextRetrievalError<Self::EngineError>> {
        Ok(unsafe { self.retrieve_glwe_ciphertext_unchecked(ciphertext) })
    }
...
impl<'data> GlweCiphertextRetrievalEngine<GlweCiphertextMutView64<'data>, &'data mut [u64]>
    for CoreEngine
{
    /// # Example:
    /// ```
    ...
    ) -> Result<&'data mut [u64], GlweCiphertextRetrievalError<Self::EngineError>> {
        Ok(unsafe { self.retrieve_glwe_ciphertext_unchecked(ciphertext) })
    }
